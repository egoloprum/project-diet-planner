...
import { signInWithAnon, signInWithGoogle } from "@/src/app/db/supabase/signin"
...
export const LoginForm = ({}) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="border-2 rounded-lg p-4 max-w-96 w-full flex flex-col gap-4 mt-6">
      <fieldset>
